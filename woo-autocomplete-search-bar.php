...
/*
 * Note:
 * http://localhost/woo/?product_tag=soccer-shoes
 *
 */
...
function auto_search_bar(){
    ...
    <form role="search" method="get" id="auto-searchform" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
	    <input type="text" class="left" value="<?php echo _e( get_search_query() ); ?>" name="<?php echo esc_attr__( $name ); ?>" id="s" placeholder="<?php _e( $woo_form_placeholder, 'woocommerce' ); ?>" />
...
function woo_autocomplete_options_page() {
    ?>
		<style>
			.form-table td{padding: 10px !important; background-color: #b3b3b3; color: white;}
			.form-table th{padding: 10px !important; background-color: lightgray; color: black;}
		    .woo_auto_admin_spans{font-size: 10px; color: red;}
			.form-table{border: 2px solid;}
		</style>
		<div class="wrap">
			<h1>Woo Autocomplete Settings</h1>
...
function display_categories_element(){
	?>
		<hr style="margin-top: -28px" /><input type="checkbox" name="autocomplete_categories" value="1" <?php checked(1, get_option('autocomplete_categories'), true); ?> /> 
	<?php
}
...
function display_tags_element(){
	?>
		<hr style="margin-top: -12px" /><input type="checkbox" name="autocomplete_tags" value="1" <?php checked(1, get_option('autocomplete_tags'), true); ?> /> 
	<?php
}
...
function display_taxonomies_element(){
	?>
		<hr style="margin-top: -28px" /><input type="checkbox" name="autocomplete_taxonomies" value="1" <?php checked(1, get_option('autocomplete_taxonomies'), true); ?> />
	<?php
}
...
function display_wooautocomplete_fields(){
	add_settings_section("section", "All Settings", null, "woo-autocomplete-options"); 
